...
#           service_selection = request.POST['service']
          
#           if password1==password2:
#                user = User.objects.create_user(first_name=firstName,last_name=lastName,password = password1,username=userName,email=email)
#                user.save()
              
#                profRegister.objects.create(firstName=firstName,lastName=lastName,email=email,fullAddress=fullAddress,phone = phone,profilePic = profilePic,experience = experience,training_certificate=training_certificate,service_selection=service_selection,user_id=user.id)
#                professional_group=Group.objects.get(name='Professional')
#                professional_group.user_set.add(user)
#                return redirect('login/')

#      return render(request,'prof_register.html')
...
# def handleLogin(request,**kwargs):
#      if request.method == 'POST':
...
#                 if g=='Customer':
#                     context=True   
#                     return redirect('/.',args={'context':context})
#                 elif g=='Professional':
#                     context=False
#                     return redirect('/.',args={'context':context})
...
#             g=request.user.groups.all()[0].name
#             if g=='Admin':
#                  return HttpResponse("Admin logged in successfully")
#                 # return redirect('/.')
#           #   if user.is_staff:
...
#         # elif g=='Professional':
#             # return redirect('login')
#             # return HttpResponse("Professional logged in successfully")
...
#     # return render(request,'professional_page.html')
